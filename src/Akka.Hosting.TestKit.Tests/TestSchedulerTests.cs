...
{
    public class TestSchedulerTests : HostingSpec
    {
        ...
        public TestSchedulerTests(ITestOutputHelper output) : base(nameof(TestSchedulerTests), output)
        {
        }
        
        protected override void ConfigureAkka(AkkaConfigurationBuilder builder, IServiceProvider provider)
        {
            builder.AddHocon(TestConfigs.TestSchedulerConfig);
            builder.WithActors((system, registry) =>
            {
                var actor = system.ActorOf(Props.Create(() => new TestReceiveActor())
                    .WithDispatcher(CallingThreadDispatcher.Id));
                registry.Register<TestActorKey>(actor);
            });
        }
        ...
        protected override async Task BeforeTestStart()
        {
            ...
            _testReceiveActor = ActorRegistry.Get<TestActorKey>();
        }
