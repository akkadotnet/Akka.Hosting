...
{
    public class DilatedTests : HostingSpec
    {
        ...
        public DilatedTests(ITestOutputHelper output) : base(nameof(DilatedTests), output)
        {
        }
        
        protected override void ConfigureAkka(AkkaConfigurationBuilder builder, IServiceProvider provider)
        {
            builder.AddHocon($"akka.test.timefactor={TimeFactor}", HoconAddMode.Prepend);
        }
